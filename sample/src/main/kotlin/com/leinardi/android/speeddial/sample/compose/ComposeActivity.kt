    ...
    AnimatedVisibility(
        ...
        SpeedDial(
            ...
            item {
                FabWithLabel(
                    onClick = {
                        showToast(context, "Direct Image PNG clicked!")
                        closeSpeedDial(overlayVisible, speedDialState)
                    },
                    labelContent = { Text("Direct Image PNG") },
                    isDirectImage = true,
                ) {
            ...
            item {
                FabWithLabel(
                    onClick = {
                        showToast(context, "Direct Folder Image clicked!")
                        closeSpeedDial(overlayVisible, speedDialState)
                    },
                    labelContent = { Text("Direct Folder Image") },
                    isDirectImage = true,
                ) {
                    androidx.compose.foundation.Image(
