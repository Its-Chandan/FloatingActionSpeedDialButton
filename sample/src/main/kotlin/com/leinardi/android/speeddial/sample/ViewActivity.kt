...
class ViewActivity : BaseUseCaseActivity() {
    ...
    private fun initSpeedDial(addActionItems: Boolean) {
        if (addActionItems) {
            ...
            speedDialView.addActionItem(
                SpeedDialActionItem.Builder(
                    R.id.fab_direct_image, R.drawable.ic_custom_color
                )
                    .setFabType(SpeedDialActionItem.TYPE_DIRECT_IMAGE)
                    .setLabel("Direct Image PNG")
                    .create(),
            )

            speedDialView.addActionItem(
                SpeedDialActionItem.Builder(
                    R.id.fab_direct_image_folder, R.drawable.ic_folder_white
                )
                    .setFabType(SpeedDialActionItem.TYPE_DIRECT_IMAGE)
                    .setLabel("Direct Folder Image")
                    .create(),
            )
        }
        ...
        speedDialView.setOnActionSelectedListener(SpeedDialView.OnActionSelectedListener { actionItem ->
            when (actionItem.id) {
                ...
                R.id.fab_direct_image -> showToast(actionItem.getLabel(this@ViewActivity) + " clicked!")
                R.id.fab_direct_image_folder -> showToast(actionItem.getLabel(this@ViewActivity) + " clicked!")
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item.itemId == R.id.action_use_cases) {
            startActivity(Intent(this@ViewActivity, UseCasesActivity::class.java))
            return true
        }
