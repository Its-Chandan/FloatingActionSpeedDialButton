...
public class FabWithLabelView extends LinearLayout {
    ...
    public void setSpeedDialActionItem(SpeedDialActionItem actionItem) {
        ...
        if (actionItem.getFabType().equals(SpeedDialActionItem.TYPE_FILL)) {
            ...
            mFab = newFab;
        } else if (actionItem.getFabType().equals(SpeedDialActionItem.TYPE_DIRECT_IMAGE)) {
            this.removeView(mFab);
            View view = inflate(getContext(), R.layout.sd_direct_image_fab, this);
            FloatingActionButton newFab = view.findViewById(R.id.sd_fab_direct_image);
            mFab = newFab;
        }
        ...
        if (actionItem.getFabSize() == SIZE_AUTO || actionItem.getFabType().equals(SpeedDialActionItem.TYPE_FILL) || actionItem.getFabType().equals(SpeedDialActionItem.TYPE_DIRECT_IMAGE)) {
