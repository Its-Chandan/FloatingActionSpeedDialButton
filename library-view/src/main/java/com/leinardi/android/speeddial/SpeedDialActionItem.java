...
public class SpeedDialActionItem implements Parcelable {
    ...
    @StringDef({ TYPE_NORMAL, TYPE_FILL, TYPE_DIRECT_IMAGE })
    ...
    public static final String TYPE_DIRECT_IMAGE = "direct_image";
     ...
     *
     * @param context A context to retrieve the Drawable from (needed for
     *                SpeedDialActionItem.Builder(int, int).
     * @return the speed dial item drawable, or null if no drawable has been
     *         assigned.
     */
    @Nullable
    ...
    public static class Builder {
         ...
         * {@link DrawableRes} as icon.
         *
         * @param id               the identifier for this action item. The identifier
         *                         must be unique to the instance
         *                         of {@link SpeedDialView}. The identifier should be a
         *                         positive number.
        ...
        /**
         * Creates a builder for a speed dial action item that uses a {@link Drawable}
         * as icon.
         * <p class="note">
         * {@link Drawable} are not parcelables so is not possible to restore them when
         * the view is
         * recreated for example after an orientation change. If possible always use the
         * {@link #Builder(int, int)}
         * </p>
         *
         * @param id       the identifier for this action item. The identifier must be
         *                 unique to the instance
         *                 of {@link SpeedDialView}. The identifier should be a positive
         *                 number.
        ...
        /**
         * Creates a builder for a speed dial action item that uses a
         * {@link SpeedDialActionItem} instance to
         * initialize the default values.
         *
         * @param speedDialActionItem it will be used for the default values of the
         *                            builder.
         */
         ...
         * SpeedDialActionItem.TYPE_FILL Set Floating Action Button image to fill the
         * button.
         */
        public Builder setFabType(@FabType String fabType) {
            mFabType = fabType;
            if (TYPE_DIRECT_IMAGE.equals(fabType)) {
                mFabImageTint = false;
                mFabBackgroundColor = Color.TRANSPARENT;
            }
            return this;
        }
